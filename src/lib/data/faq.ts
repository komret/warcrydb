...
export const faq: FAQ[] = [
	...
	},
	{
		id: 6,
		question:
			'What happens if I play <span class="card-id-DW55">Leitdorf Maneuver</span> while <span class="card-id-WA378">Whitestar\'s Guardians of the Sky</span> are in combat?',
	...
	},
	{
		id: 7,
		question:
			'What happens if I play <span class="card-id-DW47">False Orders</span> to use the support tactic on my enemy\'s <span class="card-id-WA378">Whitestar\'s Guardians of the Sky</span>?',
	...
	},
	{
		id: 8,
		question:
			'If a ready unit is removed from combat by the support tactic on <span class="card-id-WA378">Whitestar\'s Guardians of the Sky</span>, does it commit?',
	...
	},
	{
		id: 9,
		question:
			'Does the WarCry on <span class="card-id-SR106">Katarin, Bringer of Winter</span> create an aborted combat where players continue playing tactics until both of them pass, or does the combat end immediately?',
	...
	},
	{
		id: 10,
		question:
			'When you use a tactic on one of your attachments, which is considered to have used the tactic: the unit or the attachment? Will <span class="card-id-PW54">Dauntless Reckoning</span> destroy an attachment that uses a Support Tactic?',
		answer:
			'The attachment is considered to have used the tactic. <span class="card-id-PW54">Dauntless Reckoning</span> will not destroy the attachment, since it only affects units.',
		source: 'https://web.archive.org/web/20071015175836/http://sabertoothgames.com/warcry/faq.asp'
	},
	{
		id: 11,
	...
	},
	{
		id: 15,
		question:
			'If you use <span class="card-id-PW79">The Birdmen of Catrazza</span>\'s Reaction to attach an action card to them, do they get the benefits from cards that say “while this card is attached …”?',
		answer:
	...
	},
	{
		id: 16,
		question:
			'If you play an action card that attaches itself to a unit, can you use the <span class="card-id-PW79">The Birdmen of Catrazza</span>’s Combat Tactic to discard and play the attached card?',
		answer: 'Yes.',
		source: 'https://web.archive.org/web/20071015175836/http://sabertoothgames.com/warcry/faq.asp'
	},
	{
		id: 17,
		question:
			'What happens if you play an attachment on <span class="card-id-SM102">Jasenland\'s Imperial Defenders</span> and then attach them to another unit?',
		answer:
			'The attachment remains on <span class="card-id-SM102">Jasenland\'s Imperial Defenders</span>, but it still affects them, not the unit they are attached to.',
		source: 'https://web.archive.org/web/20071015175836/http://sabertoothgames.com/warcry/faq.asp'
	},
	{
		id: 18,
	...
	},
	{
		id: 19,
		question:
			'What happens if the character attachment attached to <span class="card-id-BR66">On Your Own</span> is destroyed?',
		answer:
			'<span class="card-id-BR66">On Your Own</span> becomes a unit with Strength, Tactic Points and Leadership 0. This does not change even if you re-attach the attachment.',
		source:
			'https://web.archive.org/web/20051103215025/http://www.sabertoothgames.com/forum/forum_posts.asp?TID=4394&PN=1'
	},
	{
		id: 20,
		question:
			'Does a unit attached to <span class="card-id-DH8">Invocation of Nehek</span> count as an attachment or as a unit for the purposes of card effects? For example, can I use the reaction on attached <span class="card-id-DH21">Carstein\'s Flesh Eaters</span> when they are destroyed?',
		answer:
			"It counts as a unit. Whether a card is a unit or not is determined by it's card layout. The fact that they it is attached to another unit means that it has most of the usual rules for being a unit suspended. <span class=\"card-id-DH21\">Carstein's Flesh Eaters</span>' reaction can be used.",
		source:
	...
	},
	{
		...
		answer:
			'Only if the reaction uses the word "instead", such as <span class="card-id-DH14">The Carstein Ring</span>.',
		source:
	...
	},
	{
		id: 27,
		question:
			'Can <span class="card-id-WA235">Scheme with Beauties</span> target a unit in the reserves? Can it be blocked?',
		answer:
	...
	},
	{
		id: 28,
		question:
			'When I initiate an attack with <span class="card-id-WA235">Scheme with Beauties</span>, is my unit considered to be an attacker and the enemy unit a defender?',
		answer: 'Yes.',
		source:
	...
	},
	{
		id: 29,
		question:
			'When I play <span class="card-id-BR75">Inner Conflict</span>, can I choose an infantry unit in the reserves as the target of the attack?',
		answer: 'Yes.',
		source:
	...
	},
	{
		id: 30,
		question:
			'When I play <span class="card-id-WA242">Steal a Sheep in Passing</span>, can I select an enemy unit which cannot legally declare an attack?',
		answer: 'No.',
		source:
	...
	},
	{
		id: 31,
		question:
			'When <span class="card-id-PW111">Take One Path While Pretending to Take Another</span> is in play, does choosing the defending unit count as blocking? Can other units block the attack?',
	...
	},
	{
		id: 42,
		question:
			'If you are somehow allowed to play <span class="card-id-PW55">Path of Glory</span> as a Combat Tactic, does it retroactively double/halve bonuses already played that combat?',
	...
	},
	{
		id: 43,
		question:
			'If you are somehow allowed to play <span class="card-id-PW55">Path of Glory</span> as a Combat Tactic, what happens if you play two copies of <span class="card-id-PW55">Path of Glory</span>?',
	...
	},
	{
		id: 45,
		question:
			'Does <span class="card-id-LC89">Brotherhood of Grimnir</span>\'s static ability increases their strength, does it count as a bonus? Can it be modified by card effects?',
	...
	},
	{
		id: 46,
		question:
			'If your <span class="card-id-WA312">Malakai Makaisson\'s Goblin-Hewer</span> is in a ranged combat, and you play a card that kills an enemy unit, can you use its reaction?',
		answer:
	...
	},
	{
		id: 47,
		question:
			'Can <span class="card-id-WA258">The Conscripts Arrive</span> be used to play a Support Tactic from the unit in combat?',
		answer:
	...
	},
	{
		id: 48,
		question:
			'Can <span class="card-id-WM83">Turn of Events</span> allow you to use abilities as if you were attacking?',
	...
	},
	{
		id: 49,
		question:
			'Does the ability on <span class="card-id-PW11">Gotrek and Felix</span> compare the modified strength or the base strength of enemy units?',
	...
	},
	{
		id: 50,
		question:
			'Can <span class="card-id-PW11">Gotrek and Felix</span> use their ability if the opponent has another unit with the same strength as the one they are fighting (but no units with higher strength)?',
		answer: 'Yes.',
		source: 'https://web.archive.org/web/20071015175836/http://sabertoothgames.com/warcry/faq.asp'
	},
	{
		id: 51,
		question:
			'When using the WarCry on <span class="card-id-SD10">Minotaur\'s Bane</span>, can you nominate the unit it\'s attached to?',
		answer: 'Yes.',
		source: 'https://web.archive.org/web/20071015175836/http://sabertoothgames.com/warcry/faq.asp'
	},
	{
		id: 52,
		question:
			'What happens if you use the WarCry on <span class="card-id-SD10">Minotaur\'s Bane</span>, nominate the unit it\'s attached to and lose the combat?',
	...
	},
	{
		id: 53,
		question:
			'Can <span class=WA185>Look Out, Sir!</span> be used after playing the Combat Tactic on <span class="card-id-WA292">Talisman of Strength</span>? Can it be returned to the same unit? Can the Combat Tactic be used again?',
		answer: 'Yes to all.',
		source: 'https://web.archive.org/web/20071015175836/http://sabertoothgames.com/warcry/faq.asp'
	},
	{
	...
	},
	{
		id: 55,
		question:
			'If you somehow use the Combat Tactic on the enemy\'s <span class="card-id-WA292">Talisman of Strength</span>, is it destroyed?',
		answer: 'Yes.',
		source: 'https://web.archive.org/web/20071015175836/http://sabertoothgames.com/warcry/faq.asp'
	},
	{
		id: 56,
		question:
			'Does <span class="card-id-PW21">Flames of the Phoenix</span> count itself towards the total number of Combat Tactics played that combat?',
		answer: 'Yes.',
		source: 'https://web.archive.org/web/20071015175836/http://sabertoothgames.com/warcry/faq.asp'
	},
	{
		id: 57,
		question:
			'Can you play <span class="card-id-DW45">Exploited Weakness</span> if your opponent has played <span class="card-id-DW63">Probing Attack</span> earlier that combat?',
		answer: 'Yes.',
		source: 'https://web.archive.org/web/20071015175836/http://sabertoothgames.com/warcry/faq.asp'
	},
	{
		id: 58,
		question:
			'Can <span class="card-id-WA166">Ha\'asek\'s Grief</span> be used if a unit is destroyed during combat, but is not actually one of the units in combat?',
		answer: 'No.',
		source: 'https://web.archive.org/web/20071015175836/http://sabertoothgames.com/warcry/faq.asp'
	},
	{
		id: 59,
		question:
			'Does <span class="card-id-WA50">Rikhaine\'s Black Legion</span>\' compare strength values immediately, or at the end of combat?',
	...
	},
	{
		id: 63,
		question:
			'Does <span class="card-id-BR77">Dueling Master</span> prevent players from playing regular tactics?',
		answer:
	...
	},
	{
		id: 64,
		question:
			'How does <span class="card-id-BR77">Dueling Master</span> interact with effects to skip combat rolls?',
		answer:
	...
	},
	{
		id: 65,
		question:
			'Can the combat tactic granted by <span class="card-id-BR50">Back to Basics</span> be used more than once per combat?',
		answer: 'No.',
		source:
	...
	},
	{
		id: 66,
		question:
			'If two delayed triggers cause a unit to be destroyed and prevent it from being destroyed at the same time (e.g. <span class="card-id-SD120">The Bow of the Seafarer</span> and <span class="card-id-CD30">Sacrificial Unit</span>), what happens to the unit?',
	...
	},
	{
		id: 67,
		question:
			'What happens when I play <span class="card-id-DH26">A Good Death to Save Another</span> as a reaction to a combat roll and destroy my unit in combat to pay its cost while I am losing the combat by 1, 2 or 3, respectively?',
		answer:
	...
	},
	{
		id: 68,
		question:
			'If my first tactic in combat instructs me to play another combat tactic (e.g., <span class="card-id-PW7">The Dragonhelm</span>), can I play a WarCry?',
		answer:
	...
	},
	{
		id: 69,
		question:
			'If I play a tactic via a card effect which allows me to play it before the first tactic is played (e.g. <span class="card-id-SR17">Hydra Banner</span>), can I play a WarCry later?',
	...
	},
	{
		id: 74,
		question:
			'Can I play a card committing a unit and choose a committed unit as its target? For example, can I target a committed unit with <span class="card-id-WA188">Low Morale</span> to trigger a reaction on <span class="card-id-LC8">Styrkaar of the Sortsvinaer</span>?',
	...
	},
	{
		id: 76,
		question:
			'If <span class="card-id-WA142">Duplicate</span> is used to copy a card with multiple tactics on it, do you have to choose the same tactic that was chosen when the card was first played?',
		answer: 'No.',
		source: 'https://web.archive.org/web/20071015175836/http://sabertoothgames.com/warcry/faq.asp'
	},
	{
		id: 77,
		question:
			'Can <span class="card-id-WA142">Duplicate</span> be used to copy a <span class="card-id-WA142">Duplicate</span> that had been played previously that combat?',
		answer: 'Yes.',
		source: 'https://web.archive.org/web/20071015175836/http://sabertoothgames.com/warcry/faq.asp'
	},
	{
		id: 78,
		question:
			'Can <span class="card-id-WA142">Duplicate</span> be used to copy a card that says you may only play it once per combat?',
		answer:
			'Copying a card with <span class="card-id-WA142">Duplicate</span> counts as playing it, so you may only copy those cards if your opponent played them.',
		source: 'https://web.archive.org/web/20071015175836/http://sabertoothgames.com/warcry/faq.asp'
	},
	{
		id: 79,
	...
	},
	{
		id: 80,
		question:
			'Does <span class="card-id-PW32">Decisive Maneuver</span> allow you to use abilities an additional time (like <span class="card-id-WA275">Weapons Master</span>) or on committed units (like <span class="card-id-WA258">The Conscripts Arrive</span>)?',
	...
	},
	{
		id: 81,
		question:
			'If I play <span class="card-id-PW54">Dauntless Reckoning</span> and <span class="card-id-DW47">False Orders</span>, is the supporting enemy unit destroyed?',
		answer: 'Yes.',
		source: 'https://web.archive.org/web/20071015175836/http://sabertoothgames.com/warcry/faq.asp'
	},
	{
		id: 82,
		question:
			'What happens if you use <span class="card-id-WA116">Borrowed Power</span> to copy a tactic that refers to "this unit"? What if the tactic refers to the unit by name?',
		answer:
	...
	},
	{
		id: 83,
		question:
			'Can you use <span class="card-id-WM34">Borrowed Steel</span> on an attachment that doesn\'t have a Combat Tactic that you can use?',
	...
	},
	{
		id: 84,
		question:
			'If you <span class="card-id-WA142">Duplicate</span> a card that contains the text "this card ...", which card does it refer to?',
	...
	},
	{
		id: 85,
		question:
			'What happens if I play <span class="card-id-DW47">False Orders</span> on <span class="card-id-SM102">Jasenland\'s Imperial Defenders</span>’’?',
		answer:
	...
	},
	{
		id: 86,
		question:
			'If the target of <span class="card-id-BR75">Inner Conflict</span> is committed, is its copy considered to be committed as well?',
	...
	},
	{
		id: 87,
		question:
			'If the attachment targeted by <span class="card-id-BR66">On Your Own</span> is committed, is the unit newly created unit committed as well?',
		answer: 'No.',
		source:
	...
	},
	{
		id: 89,
		question:
			'Can the unit that\'s in combat be used to satisfy the cost of <span class="card-id-WC87">Mass March</span>? If so, will this double the effects of previously played strength-increasing effects?',
		answer: 'Yes to both questions.',
		source: 'https://web.archive.org/web/20071015175836/http://sabertoothgames.com/warcry/faq.asp'
	},
	{
		id: 90,
		question:
			'Does <span class="card-id-WM40">Disruption of Support</span> make normal Support Tactics cost 1 spell point?',
		answer: 'Yes.',
		source: 'https://web.archive.org/web/20071015175836/http://sabertoothgames.com/warcry/faq.asp'
	},
	{
		id: 91,
		question:
			'Does <span class="card-id-WM40">Disruption of Support</span> make normal Support Tactics count as spell ability?',
		answer: 'No.',
		source: 'https://web.archive.org/web/20071015175836/http://sabertoothgames.com/warcry/faq.asp'
	},
	{
	...
	},
	{
		id: 93,
		question:
			'If <span class="card-id-WA142">Duplicate</span> is used to copy a tactic with a variable cost, do you have to use the same cost?',
	...
	},
	{
		id: 98,
		question:
			'If a card/ability allows you to play <span class="card-id-WA142">Duplicate</span> for free, do you have to pay the cost of the duplicated card?',
		answer:
			'Yes, but you don\'t have to pay the spell point cost for <span class="card-id-WA142">Duplicate</span> itself.',
		source: 'https://web.archive.org/web/20071015175836/http://sabertoothgames.com/warcry/faq.asp'
	},
	{
		id: 99,
	...
	},
	{
		id: 103,
		question:
			'Can you discard a strategy with a spell ability to satisfy <span class="card-id-DW8">Eldire</span>\'s ability? What if that strategy has multiple spell abilities?',
	...
	},
	{
		id: 104,
		question:
			'Does <span class="card-id-BR49">Everything Has a Price</span> affect cards without a printed tactic point cost, i.e. tactics adding tactic points?',
		answer: 'No.',
		source:
	...
	},
	{
		id: 106,
		question:
			'What happens if a unit with another unit attached to it via <span class="card-id-DH8">Invocation of Nehek</span> is carried over to the next battle?',
		answer:
	...
	},
	{
		id: 107,
		question:
			'Can I destroy a single unit with the <span class="card-id-HW48">Elven Victory</span>, <span class="card-id-HW47">Dwarven Victory</span> and <span class="card-id-HW61">Imperial Victory</span> attached to pay the cost of <span class="card-id-HW87">Victory at Any Cost</span>?',
		answer: 'No.',
		source:
	...
	},
	{
		id: 108,
		question:
			'Does <span class="card-id-SR91">Furgut</span> prevent from playing tactic cards for 0 tactic points and spell abilities for 0 spell points?',
		answer: 'No.',
	...
	},
	{
		id: 109,
		question:
			'Can <span class="card-id-WA127">Counter Spell</span> be triggered by a reaction without cost?',
		answer: 'Yes.',
	...
	},
	{
		id: 113,
		question:
			'When you muster <span class="card-id-PW44">Dhargethen\'s Bloodkith</span>, do you have to draw <span class="card-id-WC35">Naetharion Dhargethen</span> if you find it? Can you look through your discard pile as well? Do you shuffle your deck afterwards?',
	...
	},
	{
		id: 116,
		question:
			'When <span class="card-id-LC66">Re-equip</span> is played, what happens to the cards that do not get attached?',
	...
	},
	{
		id: 124,
		question:
			'What WarCries can <span class="card-id-PW8">Aranauch the Fangheart</span> play as Combat Tactics?',
		answer:
	...
	},
	{
		id: 126,
		question:
			'Does <span class="card-id-WA258">The Conscripts Arrive</span> count as using a Support Tactic?',
		answer: 'Yes.',
		source: 'https://web.archive.org/web/20071015175836/http://sabertoothgames.com/warcry/faq.asp'
	},
	{
	...
	},
	{
		id: 130,
		question:
			'Can <span class="card-id-SR95">Barak\'s Ironbeards</span> use their ability when a strategy is put into play via an event?',
		answer: 'Yes.',
		source:
	...
	},
	{
		id: 134,
		question:
			'Does using an ability on a strategy card to put it into play as a combat tactic count as playing a combat tactic? For example, can I use the support tactic on <span class="card-id-SR54">Lessons Learned</span> after I put it into play as a WarCry?',
		answer: 'Yes.',
		source:
	...
	},
	{
		id: 137,
		question:
			'What happens if <span class="card-id-WA252">Sunrise</span> is rolled during the Muster Phase?',
		answer:
	...
	},
	{
		id: 151,
		question:
			'Does the Wizard level from <span class="card-id-WA282">Cache of Scrolls</span> stack with Wizard levels on the unit it is attached to? If the unit doesn\'t have any Wizard levels, do they become a Wizard unit?',
		answer: 'Yes to both questions.',
		source: 'https://web.archive.org/web/20071015175836/http://sabertoothgames.com/warcry/faq.asp'
	},
	{
	...
	},
	{
		id: 155,
		question:
			'If you play <span class="card-id-WA18">Melekh the Changer</span> and name a unit, is your opponent prevented from mustering that unit in future muster phases?',
	...
	},
	{
		id: 156,
		question:
			'What does <span class="card-id-LC8">Styrkaar of the Sortsvinaer</span>\'s WarCry prevent the opponent from doing, if they fail the test?',
		answer:
	...
	},
	{
		id: 158,
		question:
			'Can <span class="card-id-WA98">Karkov\'s Winged Lancers</span> use their reaction to rally themselves after a card/ability commits them?',
		answer:
	...
	},
	{
		id: 159,
		question:
			'Can <span class="card-id-CE3">Luthor Huss</span> use his reaction to negate a spell card/ability that commits him?',
		answer:
	...
	},
	{
		id: 160,
		question:
			'Does <span class="card-id-DW62">Practiced Maneuver</span> prevent cards that optionally discard cards, e.g. <span class="card-id-WA165">Grim Resolution</span>?',
		answer: 'Yes.',
		source:
	...
	},
	{
		id: 161,
		question:
			'Can <span class="card-id-PW79">The Birdmen of Catrazza</span> negate a card effect that optionally discards cards, e.g. <span class="card-id-WA165">Grim Resolution</span>?',
		answer:
			'Yes, but only if their controller has enough cards in their hand to discard (i.e. at least 3 cards in case of <span class="card-id-WA165">Grim Resolution</span>).',
		source:
			'https://web.archive.org/web/20050418155619/http://www.sabertoothgames.com/forum/forum_posts.asp?TID=2950&PN=1'
	},
	{
		id: 162,
		question:
			'Can <span class="card-id-PW79">The Birdmen of Catrazza</span> negate <span class="card-id-PW113">Under Concealment of Broad Daylight</span>? Can they negate <span class="card-id-SM43">Twister</span>?',
		answer: 'Yes to both questions.',
	...
	},
	{
		id: 169,
		question:
			'When playing <span class="card-id-WM80">The Howler Wind</span> do you compare your spell points to the enemy unit\'s strength before or after paying the cost of the card?',
		answer: 'After.',
		source: 'https://web.archive.org/web/20071015175836/http://sabertoothgames.com/warcry/faq.asp'
	},
	{
		id: 170,
		question:
			'When playing <span class="card-id-WA161">Furious Charge</span> do you compare hand sizes before or after playing the card?',
		answer: 'Before.',
		source: 'https://web.archive.org/web/20071015175836/http://sabertoothgames.com/warcry/faq.asp'
	},
	{
	...
	},
	{
		id: 174,
		question:
			'If your unit loses a combat, you play <span class="card-id-DW58">Martyrs</span>, and the enemy unit fails their leadership test and becomes committed, is your unit destroyed?',
		answer:
	...
	},
	{
		id: 175,
		question:
			'Does <span class="card-id-DW15">Jezzi\'s Git Mob</span> become committed if the enemy unit gains Terror during combat?',
		answer: 'No.',
		source: 'https://web.archive.org/web/20071015175836/http://sabertoothgames.com/warcry/faq.asp'
	},
	{
		id: 176,
		question:
			'Can <span class="card-id-WA322">Snorri Nosebiter</span> be attached to a unit that already has a character attachment?',
	...
	},
	{
		id: 177,
		question:
			'What happens if <span class="card-id-WA322">Snorri Nosebiter</span> and one or more other characters are attached to a unit and <span class="card-id-WA322">Snorri Nosebiter</span> is destroyed?',
	...
	},
	{
		id: 178,
		question:
			'When playing <span class="card-id-PG52">Into the Heart of the Enemy</span>, are the relative strength values checked immediately, or at the end of combat?',
		answer: 'At the end of combat.',
		source: 'https://web.archive.org/web/20071015175836/http://sabertoothgames.com/warcry/faq.asp'
	},
	{
		...
		answer:
			'Resolve each sentence in order. If a sentence is not, or cannot, be resolved, it attempts to do as much as possible. Optional sentences do not need to be resolved in order to move on. Sentences that involve playing cards from your hand, or otherwise putting them in play (e.g. <span class="card-id-PW79">The Birdmen of Catrazza</span>) are also considered optional.',
		source: 'https://web.archive.org/web/20071015175836/http://sabertoothgames.com/warcry/faq.asp'
	},
	{
		id: 180,
		question:
			'Does the second sentence on <span class="card-id-SM40">Clinch</span> take effect if there are no attached cards or tokens in the combat?',
		answer:
	...
	},
	{
		id: 184,
		question:
			'Can <span class="card-id-WM37">Choices of War</span> be used to prevent cards played after the Tactics Phase (e.g. <span class="card-id-WA246">Strategic Withdrawal</span>)?',
		answer: 'Yes.',
		source: 'https://web.archive.org/web/20071015175836/http://sabertoothgames.com/warcry/faq.asp'
	},
	{
	...
	},
	{
		id: 186,
		question:
			'If a card effect end combat immediately (e.g. <span class="card-id-VT22">Buy Me Some Time</span>), do effects that trigger "at the end of the tactics phase" (e.g. <span class="card-id-SM54">Another Day</span>) still trigger?',
		answer: 'No.',
		source:
	...
	},
	{
		id: 187,
		question:
			'Can <span class="card-id-BD115">Luril\'s Seafarers</span> trigger their reaction before setup is over?',
	...
	},
	{
		id: 188,
		question:
			'If I play <span class="card-id-LC60">Keep Them Pinned</span> on a ranged attack unit and lose the combat, can I choose to commit the unit in combat?',
		answer: 'Yes.',
		source:
	...
	},
	{
		id: 189,
		question:
			'When <span class="card-id-SM39">Blind Fury</span> is played, who decides first which cards to select?',
	...
	},
	{
		id: 195,
		question:
			'Can the Warcry on <span class="card-id-WA33">Dhargethen\'s Duskreavers</span> be used during a ranged attack? If <span class="card-id-WA33">Dhargethen\'s Duskreavers</span> wins, do they rout the ranged attacker? Do they destroy the ranged attacker? Can they make a follow-up attack?',
		answer:
	...
	},
	{
		id: 200,
		question:
			'If one of my units initiates a ranged attack, plays <span class="card-id-WA167">Hail of Doom</span>, becomes committed during the combat and wins the combat by three or more, can it make the additional attack?',
		answer: 'No.',
		source: 'https://web.archive.org/web/20071015175836/http://sabertoothgames.com/warcry/faq.asp'
	},
	{
		id: 201,
		question:
			'When is the ranged attack value for <span class="card-id-WA350">White Plain Kossars</span> established?',
		answer:
	...
	},
	{
		id: 202,
		question:
			'What happens if the <span class="card-id-WA350">White Plain Kossars</span> receive a ranged attack bonus?',
	...
	},
	{
		id: 203,
		question:
			'When is the ranged attack value for <span class="card-id-PG23">Sniktnit\'s Warp Cannon</span> established?',
		answer:
	...
	},
	{
		id: 204,
		question:
			'Can <span class="card-id-PG23">Sniktnit\'s Warp Cannon</span> ranged attack be negated with <span class="card-id-WA139">Dissipate Magic</span>? What is its ranged attack value when not using its ranged attack?',
	...
	},
	{
		id: 205,
		question:
			'If I declare a ranged attack and my opponent plays <span class="card-id-PG44">Force the Skirmish</span>, do cards that increase my unit\'s ranged attack affect the outcome of the combat? Does my unit still win in a tie?',
		answer:
	...
	},
	{
		id: 207,
		question:
			'If you use the Command on <span class="card-id-PW101">The Thunder that Walks</span> to make a ranged attack and use <span class="card-id-WA167">Hail of Doom</span>, does <span class="card-id-PW101">The Thunder that Walks</span> commit?',
		answer:
			'If you win the original ranged attack by three or more and make the extra attack from <span class="card-id-WA167">Hail of Doom</span>, then it commits. However, if it doesn\'t make the extra attack, it doesn\'t become committed.',
		source: 'https://web.archive.org/web/20071015175836/http://sabertoothgames.com/warcry/faq.asp'
	},
	{
		id: 208,
	...
	},
	{
		id: 211,
		question:
			'When <span class="card-id-WA364">Glory\'s Fading</span> blocks an attack and uses its reaction, where do the units fight? When combat is over where do the units go?',
		answer:
	...
	},
	{
		id: 212,
		question:
			'What happens when the defender plays <span class="card-id-HW76">Run Far Away</span> during a ranged attack?',
		answer:
	...
	},
	{
		id: 215,
		question:
			'If <span class="card-id-WA344">Ratai\'s Horse Archers</span> declare a ranged attack, play <span class="card-id-WA167">Hail of Doom</span> and win by three or more, how many attacks do they make and in what order?',
		answer:
	...
	},
	{
		id: 216,
		question:
			'If the enemy declares a ranged attack against <span class="card-id-WA344">Ratai\'s Horse Archers</span> and I win, can I use their reaction to make a follow-up attack?',
		answer: 'Yes.',
		source: 'https://web.archive.org/web/20071015175836/http://sabertoothgames.com/warcry/faq.asp'
	},
	{
		id: 217,
		question:
			'I make a ranged attack with <span class="card-id-WM99">Pride of Karak-Hirn</span> against the only unit in my enemy\'s battle line, and destroy that unit. Can I make the additional attack before my enemy\'s reserves fall forward?',
	...
	},
	{
		id: 218,
		question:
			'Can I use the reaction on <span class="card-id-DW16">Jezzi\'s Poison Herders</span> after the only unit in my battle line is destroyed, but before my reserves fall forward?',
		answer:
			'No, static abilities and game rules take effect before reactions can be used (and unlike the <span class="card-id-WM99">Pride of Karak-Hirn</span>, their reaction is triggered by the destruction of a unit, not simply a unit losing combat).',
		source: 'https://web.archive.org/web/20071015175836/http://sabertoothgames.com/warcry/faq.asp'
	},
	{
		id: 219,
		question:
			'If <span class="card-id-SD113">Tyrion, Defender of Ulthuan</span> loses a combat and uses his reaction, does the opponent make a rout check? How about in a follow-up?',
		answer:
	...
	},
	{
		id: 220,
		question:
			'If <span class="card-id-SD113">Tyrion, Defender of Ulthuan</span> loses a combat and uses his reaction, does he lose his attachments?',
		answer: 'No.',
		source: 'https://web.archive.org/web/20071015175836/http://sabertoothgames.com/warcry/faq.asp'
	},
	{
		id: 221,
		question:
			'If <span class="card-id-SD113">Tyrion, Defender of Ulthuan</span> loses a combat and uses his reaction in a "Ties are for the Weak" tie-breaker, can the enemy make a follow-up attack? Can it be into <span class="card-id-WA373">Tyrion</span> again?',
		answer: 'Yes to both questions.',
		source: 'https://web.archive.org/web/20071015175836/http://sabertoothgames.com/warcry/faq.asp'
	},
	{
		id: 222,
		question:
			'If my unit wins a combat but a card/ability prevents the enemy unit from being destroyed, can I use <span class="card-id-WA342">Pfanelholt\'s Swordsmen</span> to destroy the enemy unit anyway?',
		answer: 'Yes.',
		source: 'https://web.archive.org/web/20071015175836/http://sabertoothgames.com/warcry/faq.asp'
	},
	{
		id: 223,
		question:
			'If <span class="card-id-WA342">Pfanelholt\'s Swordsmen</span> make a ranged attack and win, can they use their reaction to destroy the enemy unit?',
		answer: 'Yes.',
		source: 'https://web.archive.org/web/20071015175836/http://sabertoothgames.com/warcry/faq.asp'
	},
	{
	...
	},
	{
		id: 225,
		question:
			'Can the <span class="card-id-WA31">Black Rose Coven</span> use their reaction if they were committed before being destroyed? What if the opponent blocked their reaction during combat?',
		answer:
	...
	},
	{
		id: 226,
		question:
			'Can <span class="card-id-WA334">Kirenwulf Jasenland</span> use his reaction during the muster phase?',
	...
	},
	{
		id: 228,
		question:
			'Can you play multiple copies of <span class="card-id-WA131">Cunning Raid</span> after routing a unit? How about if you draw one of those copies from an earlier <span class="card-id-WA131">Cunning Raid</span>?',
		answer: 'Yes to both.',
		source: 'https://web.archive.org/web/20071015175836/http://sabertoothgames.com/warcry/faq.asp'
	},
	{
	...
	},
	{
		id: 230,
		question:
			'What happens if I use the ability on multiple copies of <span class="card-id-WA359">Bearers of the Sacred Flame</span>?',
		answer:
	...
	},
	{
		id: 231,
		question:
			'How is the effect on <span class="card-id-HW76">Run Far Away</span> resolved if another card effect states that my unit cannot be routed?',
	...
	},
	{
		id: 232,
		question:
			'Can I play multiple copies of <span class="card-id-LC43">Cunning Battle Plans</span> at the start of the battle?',
	...
	},
	{
		id: 233,
		question:
			'After the enemy unit receives a strength bonus of 4 or more, can I copy that bonus by <span class="card-id-BR47">Trump</span> and then reduce it by <span class="card-id-WA237">See Through the Diversion</span>?',
		answer: 'Yes.',
		source:
			'https://web.archive.org/web/20051020093003/http://www.sabertoothgames.com/forum/forum_posts.asp?TID=4756&PN=1'
	},
	...
	},
	{
		id: 238,
		question:
			'What happens if both players roll the same for <span class="card-id-PG76">Tides of Battle</span>?',
	...
	},
	{
		id: 240,
		question:
			'What happens if I use <span class="card-id-WA278">Winds of Fate</span> and the <span class="card-id-WA32">Cauldron of Blood</span> ability in the same combat?',
		answer:
			'You get two "rolls". The first is the <span class="card-id-WA278">Winds of Fate</span> roll (roll three dice and choose two). The second is the <span class="card-id-WA32">Cauldron of Blood</span> roll, which is a single die. You may choose which of the "rolls" to accept.',
		source: 'https://web.archive.org/web/20071015175836/http://sabertoothgames.com/warcry/faq.asp'
	},
	{
		id: 241,
		question:
			'What happens if <span class="card-id-LC20">Da Pump Pump Truck</span> is in combat, you play <span class="card-id-WA278">Winds of Fate</span> and then use its reaction?',
	...
	},
	{
		id: 242,
		question:
			'Can you use <span class="card-id-WM75">Strength of Focus</span> to re-roll a re-roll caused by <span class="card-id-WM75">Strength of Focus</span>? Do modifiers to the original roll apply to a re-roll? Can you use the +1 reaction on <span class="card-id-WM75">Strength of Focus</span> on a re-roll if you used it on the original roll?',
		answer:
			'No, unless you have another copy of <span class="card-id-WM75">Strength of Focus</span> in Play. No. Yes.',
		source: 'https://web.archive.org/web/20071015175836/http://sabertoothgames.com/warcry/faq.asp'
	},
	{
		id: 243,
		question:
			'Can you use the +1 from <span class="card-id-WM75">Strength of Focus</span> more than once on a given roll?',
	...
	},
	{
		id: 249,
		question:
			'If a card effect creates a slaughter and another card effect makes one unit to win instead, how is the difference the unit has won by determined for the purposes of card effects that take the difference into account, e.g. <span class="card-id-PW153">Xanax-Qol, the Rage That Burns</span>?',
		answer:
			'The combat is won by the actual difference in strength, so the reaction on <span class="card-id-PW153">Xanax-Qol, the Rage That Burns</span> can be used if the difference is 3 or less in either direction.',
		source:
	...
	},
	{
		id: 251,
		question:
			'If I use a card effect to play a combat tactic card while <span class="card-id-LW38">Confusion in Command</span> is in play, is the combat tactic affected by <span class="card-id-LW38">Confusion in Command</span>?',
		answer: 'Yes.',
		source:
	...
	},
	{
		...
		answer:
			'Because static abilities are not played, you can only play reactions to cards being discarded by an enemy card effect, but not reactions to an enemy playing an ability to discard cards. For example, when the ability on <span class="card-id-HW32">A Fortunate Wind</span> triggers, you can use  <span class="card-id-WA337">Leitdorf\'s Blood-oathed</span>, but not <span class="card-id-PW79">The Birdmen of Catrazza</span>.',
		source:
	...
	},
	{
		id: 253,
		question:
			'If a unit is granted Victory by a static ability on its card (e.g. <span class="card-id-PW31">Lord Xili-Quncani</span>), does it count as printed Victory?',
	...
	},
	{
		id: 255,
		question:
			'How does <span class="card-id-LC89">Brotherhood of Grimnir</span> interact with effects modifying strength at the end of the tactics phase, e.g. Flames of the Phonenix?',
	...
	},
	{
		id: 256,
		question:
			'If I have multiple copies of <span class="card-id-WA58">Zelekendel, Blade of Khaine</span> ready in the battle line, does my enemy have to discard multiple cards to block?',
		answer: 'Yes.',
	...
	},
	{
		id: 263,
		question:
			'When a unit enters combat via the effect on <span class="card-id-PW112">The Guest Becomes the Host</span>, does it pay tactic points for the combat tactics played by the unit it was exchanged with?',
		answer: 'No.',
		source:
	...
	},
	{
		id: 264,
		question:
			'What happens to cards and tokens attached to a unit during a combat when the unit is exchanged with another unit via the effect on <span class="card-id-PW112">The Guest Becomes the Host</span> later during the same combat?',
	...
	},
	{
		id: 265,
		question:
			'How does <span class="card-id-PW112">The Guest Becomes the Host</span> interact with <span class="card-id-WM70">Spell of Shielding</span>?',
		answer:
			'The effect of <span class="card-id-WM70">Spell of Shielding</span> is applied to the new unit instead. The unit which entered play via <span class="card-id-WM70">Spell of Shielding</span> stays in play while the new unit is destroyed at the end of the combat.',
		source:
			'https://web.archive.org/web/20051020090353/http://www.sabertoothgames.com/forum/forum_posts.asp?TID=2573&PN=1'
	},
	{
	...
	},
	{
		id: 269,
		question:
			'If I play <span class="card-id-SD68">Natural Leader</span>, is my unit\'s leadership modified by terror for leadership tests?',
		answer: 'No.',
		source: 'https://web.archive.org/web/20071015175836/http://sabertoothgames.com/warcry/faq.asp'
	},
	{
	...
	},
	{
		id: 274,
		question:
			'If I use the WarCry on <span class="card-id-WM6">Quel\'hi\'liak</span> can my opponent play a unique unit he already has in play? How about a unit I have in play? In either case, does the previous unique unit get bounced?',
		answer:
	...
	},
	{
		id: 276,
		question:
			'What if I play <span class="card-id-BR75">Inner Conflict</span> and my enemy chooses my Unique unit as the target of their attack?',
	...
	},
	{
		id: 277,
		question:
			'If <span class="card-id-DH22">Carstein\'s Grave Guard</span> is destroyed during the Muster Phase as a result of its controller\'s only wizard being bounced, does the player get their gold back?',
		answer: 'Yes.',
		source:
	...
	},
	{
		id: 278,
		question:
			'What happens when <span class="card-id-LW1">Anelia, Harridan of Slaanesh</span> enters play while <span class="card-id-WA28">Anelia, Mistress of Slaanesh</span> is in play?',
		answer:
			'Nothing happens because <span class="card-id-WA28">Anelia, Mistress of Slaanesh</span> is not Unique, and thus the Veteran rule does not affect her.',
		source:
	...
	},
	{
		id: 279,
		question:
			'In the static ability on <span class="card-id-PG93">The Green Knight</span>, does "minimum 1" refer to the bonus or the amount the bonus is reduced by?',
	...
	},
	{
		id: 282,
		question:
			'What happens if you attach <span class="card-id-WC124">Mounts</span> to <span class="card-id-LC20">Da Pump Pump Truck</span>?',
		answer:
	...
	},
	{
		id: 284,
		question:
			'Can <span class="card-id-CC2">Vardek Crom, the Conqueror</span> be brought into play after the first battle, if he is brought into play through some other means than mustering?',
		answer: 'Yes.',
		source: 'https://web.archive.org/web/20071015175836/http://sabertoothgames.com/warcry/faq.asp'
	},
	{
		id: 285,
		question:
			'What kind of card effects does <span class="card-id-SM48">Dirty Fighting</span> interact with?',
		answer:
	...
	},
	{
		id: 286,
		question:
			'If I somehow play <span class="card-id-SD1">Angkor, Father of Mammoths</span>\' WarCry during a ranged attack as an attacker, is the enemy unit destroyed?',
		answer: 'Yes.',
		source:
	...
	},
	{
		id: 288,
		question:
			'Can <span class="card-id-PW71">Liche Priest Ahkaten</span>\'s reaction target enemy Khemri units?',
	...
	},
	{
		id: 289,
		question:
			'If I draw any cards in a combat after <span class="card-id-SM39">Blind Fury</span> has been played, can I play them? If I don\'t play them, are they discarded after the resolution? Which cards can be discarded by card effects?',
		answer:
	...
	},
	{
		id: 290,
		question:
			'If <span class="card-id-WA38">Ha\'asek\'s Bolt Slinger</span> performs a ranged attack against a unit in the reserves and that unit is moved to the battle line by a card effect during combat, can its reaction be played after the combat?',
		answer: 'Yes.',
		source:
	...
	},
	{
		id: 292,
		question:
			'Does the support tactic on <span class="card-id-WA382">Blood Precedes Glory</span> add count the total amount of units removed from the game or only the units removed to pay its cost?',
	...
	},
	{
		id: 293,
		question:
			'What hapens if I play <span class="card-id-DW89">Unexpected Quarter</span> followed by a card effect forcing the enemy to dicard and draw cards, e.g. <span class="card-id-WA374">Warriors of the Fallen Tree</span>?',
	...
	},
	{
		id: 294,
		question:
			'Can I use <span class="card-id-SR60">Nothing Left</span> after I reduce the enemy unit\'s leadership by playing a card effect to gain Terror? ',
		answer: 'Yes.',
	...
	},
	{
		id: 295,
		question:
			'Can I use <span class="card-id-HF60">Never Again</span> after my enemy uses an ability for a third or subsequent time?',
		answer: 'No.',
	...
	},
	{
		id: 296,
		question:
			'Can I play <span class="card-id-SR69">Stand Together as One</span> when my enemy has no units in their battle line?',
	...
	},
	{
		id: 297,
		question:
			'If I have multiple copies of a unit in play, do they count as +1 "Victory" for <span class="card-id-BD91">General\'s Standard</span>?',
